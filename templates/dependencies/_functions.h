...
// void _bitSet(int& x, uint8_t n, PARAMS){}
// void _bitSet(byte& x, uint8_t n, PARAMS)

// void _bitSet(long& x, uint8_t n, PARAMS)
// {
//   bitSet(x, n);
//   printValueFormatted(SerialWrapper(x), id, line, index, items);
// }

// void _bitWrite(uint32_t &x, uint8_t n, uint8_t b, PARAMS)
// {
