...
var app = (function () {
    ...
    /* SideView/App.svelte generated by Svelte v3.48.0 */

    const { console: console_1 } = globals;
    const file = "SideView/App.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button0, "click", connectToSerial, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, connectToSerial });
    	return [];
    }
